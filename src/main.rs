...
#[clap(
    ...
    override_usage = "op-offline <command> [flags]",
    next_display_order = None,
    about = "1Password CLI wrapper for instant access to secrets",
    long_about = "1Password CLI wrapper for instant access to secrets
...
re-authentication or network access.
